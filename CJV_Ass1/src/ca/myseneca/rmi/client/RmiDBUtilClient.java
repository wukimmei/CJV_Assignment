...
import ca.myseneca.rmi.server.RmiDBUtilInterface;

public class RmiDBUtilClient {

	public RmiDBUtilClient() {
	...
	public static void main(String[] args) {
		...
		try {
			...
			RmiDBUtilInterface c = (RmiDBUtilInterface)Naming.lookup("rmi://localhost:1299/DBUtilService");
